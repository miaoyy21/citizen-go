...
func NewLanguage() Language {
	return Language{
		ZhCN: map[string]string{
			...
			"prop_name_2011":        "（小）生命药水",
			"prop_description_2011": "服用后，立即恢复 +{$1}生命值。",
			"prop_name_2012":        "（中）生命药水",
			"prop_description_2012": "服用后，立即恢复 +{$1}生命值。",
			"prop_name_2013":        "（大）生命药水",
			"prop_description_2013": "服用后，立即恢复 +{$1}生命值。",
			"prop_name_2021":        "（小）精气补充剂",
			"prop_description_2021": "服用后，立即恢复 +{$1}精气值。",
			"prop_name_2022":        "（中）精气补充剂",
			"prop_description_2022": "服用后，立即恢复 +{$1}精气值。",
			"prop_name_2023":        "（大）精气补充剂",
			"prop_description_2023": "服用后，立即恢复 +{$1}精气值。",
			"prop_name_2031":        "辣椒",
		...
		ZhTW: map[string]string{
			...
			"prop_name_2011":        "（小）生命藥水",
			"prop_description_2011": "服用後，立即恢復 +{$1}生命值。",
			"prop_name_2012":        "（中）生命藥水",
			"prop_description_2012": "服用後，立即恢復 +{$1}生命值。",
			"prop_name_2013":        "（大）生命藥水",
			"prop_description_2013": "服用後，立即恢復 +{$1}生命值。",
			"prop_name_2021":        "（小）精氣補充劑",
			"prop_description_2021": "服用後，立即恢復 +{$1}精氣值。",
			"prop_name_2022":        "（中）精氣補充劑",
			"prop_description_2022": "服用後，立即恢復 +{$1}精氣值。",
			"prop_name_2023":        "（大）精氣補充劑",
			"prop_description_2023": "服用後，立即恢復 +{$1}精氣值。",
			"prop_name_2031":        "辣椒",
		...
		EnUS: map[string]string{
			...
			"prop_name_2011":        "(Small) Life Potion",
			"prop_description_2011": "Upon consumption, immediately restores +{$1} HP.",
			"prop_name_2012":        "(Medium) Life Potion",
			"prop_description_2012": "Upon consumption, immediately restores +{$1} HP.",
			"prop_name_2013":        "(Large) Life Potion",
			"prop_description_2013": "Upon consumption, immediately restores +{$1} HP.",
			"prop_name_2021":        "(Small) Spirit Elixir",
			"prop_description_2021": "Upon consumption, immediately restores +{$1} MP.",
			"prop_name_2022":        "(Medium) Spirit Elixir",
			"prop_description_2022": "Upon consumption, immediately restores +{$1} MP.",
			"prop_name_2023":        "(Large) Spirit Elixir",
			"prop_description_2023": "Upon consumption, immediately restores +{$1} MP.",
