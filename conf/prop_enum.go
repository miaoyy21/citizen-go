...
var (
	...
	PropEffectArmor         PropEffect = 2101 // 使用后吸收伤害百分比，持续一段时间 10000 = 100%
	PropEffectCritical      PropEffect = 2102 // 使用后增加暴击百分比，持续一段时间 10000 = 100%
	PropEffectAccuracy      PropEffect = 2103 // 使用后增加命中百分比，持续一段时间 10000 = 100%

	PropEffectPlayerColor PropEffect = 3101 // 使用后可修改角色颜色
